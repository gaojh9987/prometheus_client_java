...
public class CollectorRegistry {
    ...
    public Enumeration<Collector.MetricFamilySamples> metricFamilySamples(boolean reset) {
        return new MetricFamilySamplesEnumeration(reset);
    }
    ...
    public Enumeration<Collector.MetricFamilySamples> filteredMetricFamilySamples(Set<String> includedNames, boolean reset) {
        return new MetricFamilySamplesEnumeration(new SampleNameFilter.Builder().nameMustBeEqualTo(includedNames).build(), reset);
    }
    ...
    public Enumeration<Collector.MetricFamilySamples> filteredMetricFamilySamples(Predicate<String> sampleNameFilter, boolean reset) {
        return new MetricFamilySamplesEnumeration(sampleNameFilter, reset);
    }
    ...
    class MetricFamilySamplesEnumeration implements Enumeration<Collector.MetricFamilySamples> {
        ...
        MetricFamilySamplesEnumeration(boolean reset) {
            this(null, reset);
        }
        ...
        MetricFamilySamplesEnumeration(Predicate<String> sampleNameFilter, boolean reset) {
            this.sampleNameFilter = sampleNameFilter;
            this.collectorIter = filteredCollectorIterator();
            this.reset = reset;
            findNextElement();
        ...
        private void findNextElement() {
            ...
            while (collectorIter.hasNext()) {
                if (reset) {
                    metricFamilySamples = collectorIter.next().collectThenReset(sampleNameFilter).iterator();
                } else {
